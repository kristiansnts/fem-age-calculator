...
function App() {
  ...
  return (
    <main id="app" className="h-screen flex items-center justify-center">
      <div className="bg-white p-5 w-11/12 max-w-3xl rounded-t-xl rounded-bl-xl rounded-br-[80px]">
      <form id="inputs" className="flex justify-between ">
        <div className="input__group mr-3 w-25">
          <span className="block mb-1 text-slate-500 text-xs tracking-widest uppercase">Day</span>
          <input className="w-full border p-3 rounded-lg" type="number" name="day" placeholder="DD" />
        </div>
        <div className="input__group mr-3 w-25">
          <span className="block mb-1 text-slate-500 text-xs tracking-widest uppercase">Month</span>
          <input className="w-full border p-3 rounded-lg" type="number" name="month" placeholder="MM"/>
        </div>
        <div className="input__group mr-3 w-25">
          <span className="block mb-1 text-slate-500 text-xs tracking-widest uppercase">Year</span>
          <input className="w-full border p-3 rounded-lg" type="number" name="year" placeholder="YYYY"/>
        </div>
      </form>
      <div className="separator my-12 border-b relative cursor-pointer">
        <img src={ArrowIcon} alt="" className="bg-primary-purple rounded-full w-12 p-3 absolute -top-5 right-1/2" />
      </div>
